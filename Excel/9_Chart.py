...
barChart.add_data(barValue, titles_from_data=True) # 차트 데이터 추가
barChart.title = "성적표" # 제목 정의
barChart.style = 10 # 미리 정의된 스타일을 적용
barChart.x_axis.title = "번호" # x축 제목 정의
barChart.y_axis.title = "점수" # y축 제목 정의


ws.add_chart(barChart, "E3") # 넣을 차트와 위치 정의
